...
const require$1 = node_module.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('dist/plugin-3616fe54.cjs.prod.js', document.baseURI).href)));
...
class AbstractVanillaExtractPlugin {
  ...
  inject(compiler, virtualLoader) {
    ...
    (_compiler$options$mod = compiler.options.module) === null || _compiler$options$mod === void 0 || _compiler$options$mod.rules.splice(0, 0, {
      test: this.test,
      use: [{
        loader: require$1.resolve('../loader'),
        options: {
