...
const require$1 = node_module.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('loader/dist/vanilla-extract-webpack-plugin-loader.cjs.prod.js', document.baseURI).href)));
const virtualFileLoader = require$1.resolve(path__default["default"].join(path__default["default"].dirname(require$1.resolve('../../package.json')), 'virtualFileLoader'));
const virtualFileLoaderExtractionFile = path__default["default"].join(path__default["default"].dirname(require$1.resolve('../../package.json')), 'extracted.js');
const virtualNextFileLoaderExtractionFile = path__default["default"].join(path__default["default"].dirname(require$1.resolve('../../package.json')), 'vanilla.virtual.css');
